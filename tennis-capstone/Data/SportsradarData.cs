...
namespace tennisCapstone.Data
{
    public class SportsradarData
    {
        ...
        {
            var client = new RestClient("https://api.sportradar.com/tennis-t2/en/tournaments.json?api_key=y4pzp5aes66erm9xsyvrdqek");
        ...
        {
            var client = new RestClient("https://api.sportradar.com/tennis-t2/en/players/rankings.json?api_key=y4pzp5aes66erm9xsyvrdqek");
            var request = new RestRequest(Method.GET);
            IRestResponse response = client.Execute(request);
        ...
        {
            var client = new RestClient($"https://api.sportradar.com/tennis-t2/en/players/{sportsRadarId}/profile.json?api_key=y4pzp5aes66erm9xsyvrdqek");
            var request = new RestRequest(Method.GET);
            IRestResponse response = client.Execute(request);
        ...
        {
            var client = new RestClient($"https://api.sportradar.com/tennis-t2/en/tournaments/{sportsRadarId}/info.json?api_key=y4pzp5aes66erm9xsyvrdqek");
            var request = new RestRequest(Method.GET);
            IRestResponse response = client.Execute(request);
